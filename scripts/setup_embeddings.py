from scripts.extraer_embeddings import extraer_texto_completo, dividir_por_subgrupos, generar_embeddings, guardar_resultado
from scripts.cargar_en_chroma import cargar_datos_en_chroma
